...
// there is a skillOfTeamA percent probability that team A will score a goal, and 
// a skillOfTeamB percent probability that teamB will score a goal.  Assume that 
// each team will score at most one goal within each interval.  Return the 
// probability that at least one team will have a prime number as its final score.
// 
// DEFINITION
// Class:PrimeSoccer
...
// 1E-9.
// -A prime number is a number that has exactly two divisors, 1 and itself. Note 
...
// Returns: 0.0
// 
// Both teams will score a goal in each interval, so the final result will be 18 
// to 18.
// 
// 2)
// 12
...
// at least one, none get prime numbers 
// 90 minutes: 18 intervals 
// make an array of 18 matches 
// what is the probability that none of the team gets prime numbers 
// probability that both of the team gets non-prime numbers 
